...
const mapJobToCardProps = (job: JobPosting, idx: number) => {
  let logo = job.image;
  ...
  return {
    ...
    tags: [
      { label: "Full Time", color: "bg-blue-100 text-blue-800" },
      {
        label: job.about.categories[0],
        color: "text-[#FFB836]",
        border: "border border-[#FFB836]",
      },
      {
        label: job.about.categories[1] || "General",
        color: "text-[#4640DE]",
...
export { sampleJobs, mapJobToCardProps, type JobPosting };